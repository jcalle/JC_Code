...
//CRIACAO DA MALHA GEOMETRICA bi dimensional sobre um retangulo Lx x Ly. Elementos triangulares e quadrilateros.
//tendo um angulo de rotacao teta. matId é o material para os elementos geometricos interiores, e com possibilidade de cuatro condiçoes fronteira.
TPZGeoMesh *CreatingGMesh2DRotated(REAL Lx, REAL Ly, REAL teta, int matId, int bc0, int bc1, int bc2, int bc3, bool triang_elements, int &DimProblem) {
	DimProblem = 2;
	int Qnodes = 4;
